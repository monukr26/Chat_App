...
fun SignUpScreen(navController: NavController,
    ...
    Column (
        ...
        Text(text = "Create Your Account", fontSize = 28.sp, color = Color(0xFF55B4F5), fontWeight = FontWeight.Bold)
        Spacer(Modifier.height(8.dp))
        Text(text = "All Field Required", fontSize = 16.sp)
        ...
        Button(
            onClick = {
                authModel.createAccount(email, password)
            },
        ...
        Row (
            ...
            TextButton(
                ...
                Text(text = "Login", fontSize = 16.sp, color = Color(0xFFEE6666))
            }
